...
import datetime, gevent, os, random, re, socket, sys, tempfile, threading, time, traceback, unittest
...
class TestAuthConnection(TestPrivateServer):
    ...
    def test_connect_long_auth(self):
        ...
        self.assertRaisesRegexp(
            r.ReqlDriverError, "Could not connect to %s:%d: Wrong password" % (self.host, self.port),
