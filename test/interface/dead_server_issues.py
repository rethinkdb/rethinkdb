...
import driver, http_admin, scenario_common, vcoptparse
...
with driver.Metacluster() as metacluster:
    ...
    prince_hamlet_files = driver.Files(metacluster, server_name="PrinceHamlet", db_path="prince-hamlet-db", console_output="prince-hamlet-create-output", command_prefix=command_prefix)
    ...
    king_hamlet_files = driver.Files(metacluster, server_name="KingHamlet", db_path="king-hamlet-db", console_output="king-hamlet-create-output", command_prefix=command_prefix)
