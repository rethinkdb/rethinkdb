...
with driver.Metacluster() as metacluster:
    ...
    prince_hamlet_files = driver.Files(metacluster, machine_name = "PrinceHamlet", db_path = "prince-hamlet-db", executable_path = executable_path, command_prefix = command_prefix)
    prince_hamlet = driver.Process(cluster, prince_hamlet_files, log_path = "prince-hamlet-log",
        executable_path = executable_path, command_prefix = command_prefix, extra_options = serve_options)
    king_hamlet_files = driver.Files(metacluster, machine_name = "KingHamlet", db_path = "king-hamlet-db", executable_path = executable_path, command_prefix = command_prefix)
