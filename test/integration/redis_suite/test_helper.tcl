...
set ::host 127.0.0.1
set ::port 6380; # The port we run rethinkdb on for tests in case we want to run redis in parallel
set ::traceleaks 0
set ::valgrind 0
set ::verbose 1
set ::denytags {}
...
#    execute_tests "integration/redis-cli"
    ...
    # run tests with VM enabled # irrelevant when testing rethinkdb
