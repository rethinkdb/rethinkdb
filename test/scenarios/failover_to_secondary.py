...
with driver.Metacluster() as metacluster:
    ...
    primary = driver.Process(cluster, driver.Files(metacluster, db_path = "db-1"), log_path = "serve-output-1", executable_path = executable_path)
    secondary = driver.Process(cluster, driver.Files(metacluster, db_path = "db-2"), log_path = "serve-output-2", executable_path = executable_path)
    ...
    host, port = driver.get_namespace_host(ns, [secondary])
