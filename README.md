...
RethinkDB can be built using CMake for better cross-platform support and modern build tooling:
...
# The executable will be located at: build/Release/src/rethinkdb
```
...
- Boost, OpenSSL, Protobuf, and other dependencies (managed by Conan)

For more detailed build instructions, please see [BUILD.md](BUILD.md).
