...
PROTOC_CXXFLAGS := $(CXXFLAGS) -I $(PROTOC_JS_DIR) -I $(PROTOC_JS_DIR)/js
...
$(PROTOC_JS_BUILD_DIR)/js/%.pb.cc: $(PROTOC_JS_DIR)/js/%.proto | $(PROTOC_JS_BUILD_DIR)/.
	$P PROTOC
	$(PROTOC) \
	  $(PROTOC_CXXFLAGS) \
...
$(PROTOC_JS_PLUGIN): $(PROTOC_JS_BUILD_DIR)/js/int64_encoding.pb.cc
	$P CC
	$(CXX) $(PROTOC_LDFLAGS) $(PROTOC_CXXFLAGS) \
