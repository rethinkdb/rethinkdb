...
* Added a `--temp-dir` option to `rethinkdb dump` and `rethinkdb import` (#2783)
...
* Improve the performance of inserting large objects from the JavaScript driver (#2641)
...
* Improved teh garbage collection for `r.js` (#2642)
