...
// hash: "af4a882046eb3786deeaeac78a5dc06cdff007bd"
reql_docs = {
  "api/javascript/add/": {
  ...
  "api/javascript/changes/": {
    "body": "table.changes() &rarr; streamsingleSelection.changes() &rarr; stream", 
    "description": "<p>Return an infinite stream of objects representing changes to a table or a document.</p>", 
  ...
  "api/javascript/group/": {
    "body": "sequence.group(fieldOrFunction..., [{index: \"indexName\", multi: false}]) &rarr; grouped_stream", 
  ...
  "api/javascript/map/": {
    "body": "sequence1.map([sequence2, ...], mappingFunction) &rarr; streamarray1.map([sequence2, ...], mappingFunction) &rarr; arrayr.map(sequence1[, sequence2, ...], mappingFunction) &rarr; streamr.map(array1[, array2, ...], mappingFunction) &rarr; array", 
  ...
  "api/javascript/reconfigure/": {
    "body": "table.reconfigure({shards: <s>, replicas: <r>[, primaryTag: <t>, dryRun: false}]) &rarr; objectdatabase.reconfigure({shards: <s>, replicas: <r>[, primaryTag: <t>, dryRun: false}]) &rarr; object", 
  ...
  "api/javascript/wait/": {
    "body": "table.wait() &rarr; objectdatabase.wait() &rarr; objectr.wait() &rarr; object", 
