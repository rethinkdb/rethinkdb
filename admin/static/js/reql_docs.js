...
reql_docs = {
  ...
  "api/javascript/bit_sal/": {
    "body": "number.bitSal(number[, number, ...]) &rarr; numbernumber.bitShl(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the left arithmetic shift (left logical shift) of one or more values..</p>",
  ...
  "api/javascript/bit_shr/": {
    "body": "number.bitShr(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the right logical shift of one or more values.</p>",
    "example": "<p><strong>Example:</strong></p>\n<pre><code>&gt; r.expr(-43).bitShr(2).run(conn, callback)\n// result passed to callback\n1073741813\n</code></pre>",
    "io": [
      [
        "number",
        "number"
