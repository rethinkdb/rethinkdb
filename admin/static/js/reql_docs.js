...
// sha256sum (from '{' to '}' inclusive):
// 01083e7a8c0f0491a0a0fa438a05088e1b19f656b78e02aafc22cc27c665eb42
reql_docs = {
  "api/javascript/add/": {
  ...
  "api/javascript/bit_and/": {
    "body": "r.bitAnd(number) &rarr; numberr.bitAnd(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the arithmetic \"and\" of one or more values. <code>bitAnd</code> takes one or more arguments.</p>",
    "example": "<p><strong>Example:</strong> Compute the arithmetic \"and\" of <code>6</code> and <code>4</code></p>\n<pre><code>r.expr(6).bitAnd(4).run(conn)\n</code></pre>",
    "io": [
      [
        "number",
        "number"
  ...
  "api/javascript/bit_not/": {
    "body": "r.bitNot() &rarr; number",
    "description": "<p>Compute the arithmetic inverse (not) of an expression. <code>bitNot</code> takes no arguments.</p>",
    "example": "<p><strong>Example:</strong> Negate the arithmetice expression</p>\n<pre><code>r.expr(15).bitNot().run(conn)\n</code></pre>",
    "io": [
      [
        "number",
        "number"
  ...
  "api/javascript/bit_or/": {
    "body": "r.bitOr(number) &rarr; numberr.bitOr(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the arithmetic \"or\" of one or more values. <code>bitOr</code> takes one or more arguments.</p>",
    "example": "<p><strong>Example:</strong> Compute the arithmetic \"or\" of <code>6</code> and <code>4</code></p>\n<pre><code>r.expr(6).bitOr(4).run(conn)\n</code></pre>",
    "io": [
      [
        "number",
        "number"
  ...
  "api/javascript/bit_sal/": {
    "body": "r.bitSal(number) &rarr; numberr.bitSal(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the left arithmetic shift (left logical shift) of one or more values. <code>bitSal</code> takes one or more arguments.</p>",
    "example": "<p><strong>Example:</strong> Compute the left arithmetic shift of <code>5</code> and <code>4</code></p>\n<pre><code>r.expr(5).bitSal(4).run(conn)\n</code></pre>",
    "io": [
      [
        "number",
        "number"
  ...
  "api/javascript/bit_sar/": {
    "body": "r.bitSar(number) &rarr; numberr.bitSar(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the right arithmetic shift of one or more values. <code>bitSar</code> takes one or more arguments.</p>",
    "example": "<p><strong>Example:</strong> Compute the right arithmetic shift of <code>32</code> and <code>3</code></p>\n<pre><code>r.expr(32).bitSar(3).run(conn)\n</code></pre>",
    "io": [
      [
        "number",
        "number"
  ...
  "api/javascript/bit_xor/": {
    "body": "r.bitXor(number) &rarr; numberr.bitXor(number[, number, ...]) &rarr; number",
    "description": "<p>Compute the arithmetic \"and\" of one or more values. <code>bitXor</code> takes one or more arguments.</p>",
    "example": "<p><strong>Example:</strong> Compute the arithmetic \"and\" of <code>6</code> and <code>4</code></p>\n<pre><code>r.expr(6).bitXor(4).run(conn)\n</code></pre>",
    "io": [
      [
        "number",
        "number"
  ...
  "api/javascript/format/": {
    "body": "r.format(string, object) &rarr; string",
    "description": "<p>Format command takes a string as a template and formatting parameters as an object. The parameters in the template string must exist as keys in the object, otherwise, an error raised. The template must be a string literal and cannot be the result of other commands.</p>",
    "example": "<p><strong>Example:</strong> Using simple parameters for formatting.</p>\n<pre><code>r.format(\"{name} loves {candy}.\", {\n    \"name\": \"Bob\",\n    \"candy\": \"candy floss\",\n}).run(conn, callback)\n</code></pre>\n<p>Result:</p>\n<pre><code>\"Bob loves candy floss.\"\n</code></pre>\n<p><strong>Example:</strong> Using row for formatting.</p>\n<pre><code>r.table(\"movies\").map({\n  id: r.row('id'),\n  ratings: r.http(r.format('http://example.com/movies/?title={title}&amp;release={year}', r.row))\n})\n</code></pre>\n<p>Result:</p>\n<pre><code>// `ratings` is the result of the HTTP request\n[{ id: 1, ratings: { positive: 99, negative: 0 }}]\n</code></pre>",
    "io": [
      [
        "r",
        "string"
  ...
  "api/javascript/get_write_hook/": {
    "body": "table.getWriteHook() &rarr; null/object",
    "description": "<p>Gets the write hook of this table. If a write hook exists, the result is an object of the following form:</p>\n<p><code>js\n{\n  \"function\": &lt;binary&gt;,\n  \"query\": \"setWriteHook(function(_var1, _var2, _var3) { return ...; })\",\n}</code></p>",
    "example": "",
    "io": [
      [
        "table",
  ...
  "api/javascript/http/": {
    ...
    "description": "<p>Retrieve data from the specified URL over HTTP.  The return type depends on the <code>resultFormat</code> option, which checks the <code>Content-Type</code> of the response by default. Make sure that you <strong>never</strong> use this command for <strong>user provided</strong> URLs.</p>",
  ...
  "api/javascript/set_write_hook/": {
    "body": "table.setWriteHook(function | binary | null) &rarr; object",
    "description": "<p>Sets the write hook on a table or overwrites it if one already exists.</p>\n<p>The <code>function</code> can be an anonymous function with the signature <code>(context: object, oldVal: object, newVal: object) -&gt; object</code> or a binary representation obtained from the <code>function</code> field of <a href=\"/api/javascript/get_write_hook\">getWriteHook</a>. The function must be deterministic, and so cannot use a subquery or the <code>r.js</code> command.</p>",
    "example": "",
    "io": [
      [
        "table",
