...
// 370f523e62a3df45fe016fe23d428377a7c15e7c6d920364f809177111ff233c
reql_docs = {
  "api/javascript/add/": {
  ...
  "api/javascript/bit_shl/": {
    "body": "r.bitShl(number) &rarr; numberr.bitShl(number[, number, ...]) &rarr; number", 
    "description": "<p>Compute the left logical shift of one or more values. <code>bitShl</code> takes one or more arguments.</p>", 
    "example": "<p><strong>Example:</strong> Compute the left logical shift of <code>5</code> and <code>4</code></p>\n<pre><code>r.expr(5).bitShl(4).run(conn)\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
  ...
  "api/javascript/bit_shr/": {
    "body": "r.bitShr(number) &rarr; numberr.bitShr(number[, number, ...]) &rarr; number", 
    "description": "<p>Compute the right logical shift of one or more values. <code>bitShr</code> takes one or more arguments.</p>", 
    "example": "<p><strong>Example:</strong> Compute the logical right shift of <code>6</code> and <code>4</code></p>\n<pre><code>r.expr(6).bitShr(4).run(conn)\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
