...
// hash: "010768c8107d161d10b790bd0e9d5a675d24f223"
reql_docs = {
  "api/javascript/add/": {
  ...
  "api/javascript/changes/": {
    "body": "stream.changes({squash: false, includeStates: false}) &rarr; streamsingleSelection.changes({squash: false, includeStates: false}) &rarr; stream", 
  ...
  "api/javascript/contains/": {
    "body": "sequence.contains(value|predicate[, value|predicate, ...]) &rarr; bool", 
  ...
  "api/javascript/eq_join/": {
    "body": "sequence.eqJoin(leftField, rightTable[, {index:'id'}]) &rarr; sequencesequence.eqJoin(function, rightTable[, {index:'id'}]) &rarr; sequence", 
  ...
  "api/javascript/event_emitter/": {
    ...
    "description": "<p>Connections implement the same interface as Node's <a href=\"http://nodejs.org/api/events.html#events_class_events_eventemitter\">EventEmitter</a>. This allows you to listen for changes in connection state.</p>", 
    "example": "", 
  ...
  "api/javascript/map/": {
    "body": "sequence1.map([sequence2, ...], mappingFunction) &rarr; streamarray1.map([array2, ...], mappingFunction) &rarr; arrayr.map(sequence1[, sequence2, ...], mappingFunction) &rarr; streamr.map(array1[, array2, ...], mappingFunction) &rarr; array", 
  ...
  "api/javascript/replace/": {
    "body": "table.replace(object | expr[, {durability: \"hard\", returnChanges: false, nonAtomic: false}])&rarr; objectselection.replace(object | expr[, {durability: \"hard\", returnChanges: false, nonAtomic: false}])&rarr; objectsingleSelection.replace(object | expr[, {durability: \"hard\", returnChanges: false, nonAtomic: false}])&rarr; object", 
  ...
  "api/javascript/union/": {
    ...
    "description": "<p>Concatenate two or more sequences.</p>", 
  ...
  "api/javascript/update/": {
    "body": "table.update(object | expr[, {durability: \"hard\", returnChanges: false, nonAtomic: false}])&rarr; objectselection.update(object | expr[, {durability: \"hard\", returnChanges: false, nonAtomic: false}])&rarr; objectsingleSelection.update(object | expr[, {durability: \"hard\", returnChanges: false, nonAtomic: false}])&rarr; object", 
