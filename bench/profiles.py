...
L1D_CACHE_LD = Event('L1D_CACHE_LD', 90000, 0x1, 0, 1)
STORE_BLOCKS = Event('STORE_BLOCKS', 90000, 0xf, 0, 1)
L1D = Event('L1D', 90000, 0x01, 0, 1) #L1 cache miss
L2_LINES_IN = Event('L2_LINES_IN', 90000, 0x7, 0, 1)
DTLB_LOAD_MISSES = Event('DTLB_LOAD_MISSES', 90000, 0x1, 0, 1) #page walks
