...
#define vlogSTDOUT(fmt, args) vlog_internal(__FILE__, __LINE__, log_level_stdout, (fmt), (args))
#define vlogSTDERR(fmt, args) vlog_internal(__FILE__, __LINE__, log_level_stderr, (fmt), (args))
