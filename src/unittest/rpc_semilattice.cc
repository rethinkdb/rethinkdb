...
void run_single_metadata_test() {
    ...
    connectivity_cluster_t::run_t cr(&c, get_unittest_addresses(), port, &slm, portno_t::zero(), NULL);
...
void run_metadata_exchange_test() {
    ...
    connectivity_cluster_t::run_t run1(&cluster1, get_unittest_addresses(), port, &slm1, portno_t::zero(), NULL);
    connectivity_cluster_t::run_t run2(&cluster2, get_unittest_addresses(), port.with_offset(1), &slm2, portno_t::zero(), NULL);
...
void run_watcher_test() {
    ...
    connectivity_cluster_t::run_t run(&cluster, get_unittest_addresses(), port, &slm, portno_t::zero(), NULL);
