...
void run_mailbox_start_stop_test() {
    ...
    connectivity_cluster_t::run_t r(&c, get_unittest_addresses(), port, &m, portno_t::zero(), NULL);
...
void run_mailbox_message_test() {
    ...
    connectivity_cluster_t::run_t r1(&c1, get_unittest_addresses(), port, &m1, portno_t::zero(), NULL);
    connectivity_cluster_t::run_t r2(&c2, get_unittest_addresses(), port.with_offset(1), &m2, portno_t::zero(), NULL);
