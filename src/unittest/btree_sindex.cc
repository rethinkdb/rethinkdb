...
void run_sindex_low_level_operations_test() {
...

    {
        ...
        get_btree_superblock_and_txn(&btree, rwi_write, 1, repli_timestamp_t::invalid, otok, NULL, &superblock, &txn);
    ...
    for (int i = 0; i < 50; ++i) {
        ...
        created_sindexs.insert(id);
        {
            ...
            store.acquire_superblock_for_write(rwi_write, repli_timestamp_t::invalid,
                                               1, NULL, &token_pair.main_write_token, &txn, &super_block, &dummy_interuptor);
...

        {
            ...
            store.acquire_superblock_for_write(rwi_write,
                    repli_timestamp_t::invalid, 1, NULL,
