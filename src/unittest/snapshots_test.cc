...
private:
    static void test_snapshot_acq_blocks_on_unfinished_create(cache_t *cache) {
        ...
        transactor_t t0(cache, rwi_write, 0, repli_timestamp_t::distant_past);
    ...
    static void test_snapshot_sees_changes_started_before_its_first_block_acq(cache_t *cache) {
        ...
        transactor_t t1(cache, rwi_read, 0, repli_timestamp::invalid);
        transactor_t t2(cache, rwi_write, 0, repli_timestamp_t::distant_past);
    ...
    static void test_snapshot_blocks_on_txns_that_acq_first_block_earlier(cache_t *cache) {
        ...
        transactor_t t1(cache, rwi_write, 0, repli_timestamp_t::distant_past);
    ...
    static void test_cow_delete(cache_t * cache) {
        ...
        transactor_t t1(cache, rwi_read, 0, repli_timestamp::invalid);
        transactor_t t2(cache, rwi_read, 0, repli_timestamp::invalid);
        transactor_t t3(cache, rwi_write, 0, repli_timestamp_t::distant_past);
