...
void run_with_broadcaster(
    ...
    mock::test_store_t<memcached_protocol_t> initial_store(io_backender.get(), &order_source, static_cast<memcached_protocol_t::context_t *>(NULL));
    cond_t interruptor;
...
void run_partial_backfill_test(io_backender_t *io_backender,
    ...
    mock::test_store_t<memcached_protocol_t> store2(io_backender, order_source, static_cast<memcached_protocol_t::context_t *>(NULL));
    cond_t interruptor;
