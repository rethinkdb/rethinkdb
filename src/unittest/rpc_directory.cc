...
TEST(RPCDirectoryTest, OneNode) {
    run_in_thread_pool(&run_one_node_test, 1);
}
...
TEST(RPCDirectoryTest, ThreeNodes) {
    run_in_thread_pool(&run_three_nodes_test, 1);
}
...
TEST(RPCDirectoryTest, Exchange) {
    run_in_thread_pool(&run_exchange_test, 1);
}
...
TEST(RPCDirectoryTest, Update) {
    run_in_thread_pool(&run_update_test, 1);
}
...
TEST(RPCDirectoryTest, DestructorRace) {
    run_in_thread_pool(&run_destructor_race_test, 1);
}
