...
public:
    ...
    void block_read(const boost::shared_ptr<serializer_block_token_t>& token_, void *buf, file_account_t *io_account, iocallback_t *callback);
    void block_read(const boost::shared_ptr<serializer_block_token_t>& token_, void *buf, file_account_t *io_account);
    ...
    boost::shared_ptr<serializer_block_token_t> block_write(const void *buf, file_account_t *io_account, iocallback_t *cb);
    boost::shared_ptr<serializer_block_token_t> block_write(const void *buf, block_id_t block_id, file_account_t *io_account);
    boost::shared_ptr<serializer_block_token_t> block_write(const void *buf, file_account_t *io_account);
