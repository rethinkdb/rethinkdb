...
private:
    ...
    void wrap_token(block_id_t block_id, scs_block_info_t info, refc_ptr_t<typename serializer_traits_t<inner_serializer_t>::block_token_type> inner_token, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);
    void wrap_buf_token(block_id_t block_id, const void *buf, refc_ptr_t<typename serializer_traits_t<inner_serializer_t>::block_token_type> inner_token, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);
...
public:
    ...
    void index_read(block_id_t block_id, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);

    void block_read(const refc_ptr_t< scs_block_token_t<inner_serializer_t> >& token_, void *buf, file_account_t *io_account, iocallback_t *callback);
    void block_read(const refc_ptr_t< scs_block_token_t<inner_serializer_t> >& token_, void *buf, file_account_t *io_account);
    ...
    void block_write(const void *buf, block_id_t block_id, file_account_t *io_account, iocallback_t *cb, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);
    void block_write(const void *buf, file_account_t *io_account, iocallback_t *cb, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);
    void block_write(const void *buf, block_id_t block_id, file_account_t *io_account, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);
    void block_write(const void *buf, file_account_t *io_account, refc_ptr_t< scs_block_token_t<inner_serializer_t> > *tok_out);
