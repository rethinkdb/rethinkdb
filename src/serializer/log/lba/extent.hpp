...
public:
    extent_t(extent_manager_t *em, rdb_file_t *file);   // Creates new extent
    extent_t(extent_manager_t *em, rdb_file_t *file, int64_t loc, size_t size);   // Recreates extent at given offset (used during startup)
