...
public:
    ...
    void index_read(block_id_t block_id, refc_ptr<ls_block_token_pointee_t> *tok_out);

    void block_read(const refc_ptr<ls_block_token_pointee_t>& token, void *buf, file_account_t *io_account, iocallback_t *cb);

    void block_read(const refc_ptr<ls_block_token_pointee_t>& token, void *buf, file_account_t *io_account);
