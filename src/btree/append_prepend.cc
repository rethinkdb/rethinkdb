...
append_prepend_result_t btree_append_prepend(const store_key_t &key, btree_slice_t *slice, sequence_group_t *seq_group, unique_ptr_t<data_provider_t> data, bool append, castime_t castime, order_token_t token) {
