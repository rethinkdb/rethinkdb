...
get_result_t btree_get(const store_key_t &key, btree_slice_t *slice, order_token_t token, const boost::scoped_ptr<transaction_t>& txn, got_superblock_t& superblock);
