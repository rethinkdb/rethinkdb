...
class internal_node_handler : public node_handler {
    ...
    static bool is_underfull(const btree_internal_node *node);
    static bool change_unsafe(const btree_internal_node *node);
    static bool is_mergable(const btree_internal_node *node, const btree_internal_node *sibling, const btree_internal_node *parent);
    static bool is_singleton(const btree_internal_node *node);

    static void validate(const btree_internal_node *node);
