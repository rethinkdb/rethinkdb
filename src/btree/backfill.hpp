...
void btree_backfill(btree_slice_t *slice, sequence_group_t *seq_group, const key_range_t& key_range, repli_timestamp_t since_when, const boost::shared_ptr<cache_account_t>& backfill_account, backfill_callback_t *callback, order_token_t token);
...
void do_agnostic_btree_backfill(value_sizer_t<void> *sizer, btree_slice_t *slice, sequence_group_t *seq_group, const key_range_t& key_range, repli_timestamp_t since_when, const boost::shared_ptr<cache_account_t>& backfill_account, agnostic_backfill_callback_t *callback, order_token_t token);


template <class V>
void agnostic_btree_backfill(btree_slice_t *slice, sequence_group_t *seq_group, const key_range_t& key_range, repli_timestamp_t since_when, const boost::shared_ptr<cache_account_t>& backfill_account, agnostic_backfill_callback_t *callback, order_token_t token) {
