...
void insert_root(block_id_t root_id, buf_lock_t& sb_buflock) {
    rassert(sb_buflock.is_acquired());
    ptr_cast<btree_superblock_t>(sb_buflock.buf()->get_data_write())->root_block = root_id;
