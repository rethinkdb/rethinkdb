...
const const_buffer_group_t *large_value_data_provider_t::get_data_as_buffers() throw (data_provider_failed_exc_t) {
    ...
    rassert(0 == memcmp(large_value->get_root_ref()->block_ids, lb_ref.block_ids, large_value->get_root_ref()->refsize(block_size_t::unsafe_make(4096)) - sizeof(large_buf_ref)));
