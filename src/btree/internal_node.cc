...
bool level(block_size_t block_size, internal_node_t *node, internal_node_t *sibling, btree_key *key_to_replace, btree_key *replacement_key, internal_node_t *parent) {
    validate(block_size, node);
