...
BACKUP_SCRIPTS := $(EXPORT_SCRIPT_NAME) $(IMPORT_SCRIPT_NAME) $(DUMP_SCRIPT_NAME) $(RESTORE_SCRIPT_NAME)
...
$(EXPORT_SCRIPT_NAME): $(EXPORT_SCRIPT_SRC)
	$P CP $@
	cp $(EXPORT_SCRIPT_SRC) $(BUILD_DIR)

$(IMPORT_SCRIPT_NAME): $(IMPORT_SCRIPT_SRC)
	$P CP $@
	cp $(IMPORT_SCRIPT_SRC) $(BUILD_DIR)

$(DUMP_SCRIPT_NAME): $(DUMP_SCRIPT_SRC)
	$P CP $@
	cp $(DUMP_SCRIPT_SRC) $(BUILD_DIR)

$(RESTORE_SCRIPT_NAME): $(RESTORE_SCRIPT_SRC)
	$P CP $@
