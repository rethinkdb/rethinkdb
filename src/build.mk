...
ifeq ($(BENCHMARKS),1)
  $(SOURCE_DIR)/all: $(BUILD_DIR)/$(SERVER_BENCHMARK_NAME)
endif
...
.PHONY: benchmark
benchmark: $(BUILD_DIR)/$(SERVER_BENCHMARK_NAME)
	$P RUN $(SERVER_BENCHMARK_NAME)
	$(BUILD_DIR)/$(SERVER_BENCHMARK_NAME) --benchmark_filter=$(BENCHMARK_FILTER)
