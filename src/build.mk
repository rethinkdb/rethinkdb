...
$(OBJ_DIR)/%.o: $(SOURCE_DIR)/%.cc $(MAKEFILE_DEPENDENCY) $(V8_INCLUDE_DEP) $(RE2_INCLUDE_DEP) $(Z_INCLUDE_DEP) $(BOOST_INCLUDE_DEP) $(CURL_INCLUDE_DEP) $(CRYPTO_INCLUDE_DEP) | $(QL2_PROTO_OBJS)
