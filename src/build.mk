...
SERVER_EXEC_OBJS := $(QL2_PROTO_OBJS) $(DUKTAPE_OBJ) $(patsubst $(SOURCE_DIR)/%.cc,$(OBJ_DIR)/%.o,$(SERVER_EXEC_SOURCES)) $(QUICKJS_A)

SERVER_NOMAIN_OBJS := $(QL2_PROTO_OBJS) $(DUKTAPE_OBJ) $(patsubst $(SOURCE_DIR)/%.cc,$(OBJ_DIR)/%.o,$(filter-out %/main.cc,$(SOURCES))) $(QUICKJS_A)
