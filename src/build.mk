...
BACKUP_SCRIPTS := $(BUILD_DIR)/$(EXPORT_SCRIPT_NAME) $(BUILD_DIR)/$(IMPORT_SCRIPT_NAME) $(BUILD_DIR)/$(DUMP_SCRIPT_NAME) $(BUILD_DIR)/$(RESTORE_SCRIPT_NAME)
...
$(BUILD_DIR)/$(EXPORT_SCRIPT_NAME): $(EXPORT_SCRIPT_SRC)
	$P CP $@
	cp $(EXPORT_SCRIPT_SRC) $(BUILD_DIR)

$(BUILD_DIR)/$(IMPORT_SCRIPT_NAME): $(IMPORT_SCRIPT_SRC)
	$P CP $@
	cp $(IMPORT_SCRIPT_SRC) $(BUILD_DIR)

$(BUILD_DIR)/$(DUMP_SCRIPT_NAME): $(DUMP_SCRIPT_SRC)
	$P CP $@
	cp $(DUMP_SCRIPT_SRC) $(BUILD_DIR)

$(BUILD_DIR)/$(RESTORE_SCRIPT_NAME): $(RESTORE_SCRIPT_SRC)
	$P CP $@
	cp $(RESTORE_SCRIPT_SRC) $(BUILD_DIR)

.PHONY: rethinkdb
rethinkdb: $(BUILD_DIR)/$(SERVER_EXEC_NAME)

$(BUILD_DIR)/$(SERVER_EXEC_NAME): $(SERVER_EXEC_OBJS) $(BACKUP_SCRIPTS) | $(BUILD_DIR)/. $(TCMALLOC_DEP) $(PROTOBUF_DEP)
	$P LD $@
