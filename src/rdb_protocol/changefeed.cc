...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(msg_t, op);
RDB_IMPL_ME_SERIALIZABLE_2_SINCE_1_13(msg_t::change_t, empty_ok(old_val), empty_ok(new_val));
RDB_IMPL_SERIALIZABLE_0_SINCE_1_13(msg_t::stop_t);
