...
RDB_IMPL_ME_SERIALIZABLE_1_SINCE_1_13(backtrace_t, frames);
RDB_IMPL_ME_SERIALIZABLE_3_SINCE_1_13(backtrace_t::frame_t, type, pos, opt);
RDB_IMPL_ME_SERIALIZABLE_3_SINCE_1_13(exc_t, type_, backtrace_, exc_msg_);
RDB_IMPL_ME_SERIALIZABLE_2_SINCE_1_13(datum_exc_t, type_, exc_msg);
