...
public:
    javascript_term_t(visibility_env_t *env, const protob_t<const Term> &term)
...
counted_t<term_t> make_javascript_term(visibility_env_t *env, const protob_t<const Term> &term) {
