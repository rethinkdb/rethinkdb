...
RDB_IMPL_SERIALIZABLE_2(start_t, description_, when_);
...
RDB_IMPL_SERIALIZABLE_1(split_t, n_parallel_jobs_);
...
RDB_IMPL_SERIALIZABLE_3(sample_t, description_, mean_duration_, n_samples_);

stop_t::stop_t()
    : when_(get_ticks()) { }

RDB_IMPL_SERIALIZABLE_1(stop_t, when_);
