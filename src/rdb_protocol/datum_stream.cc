...
void reader_t::accumulate(env_t *env, eager_acc_t *acc,
...
std::vector<rget_item_t> reader_t::do_range_read(env_t *env,
                                                     const read_t &read) {
    ...
    grouped_t<stream_t> *gs =
        boost::get<grouped_t<stream_t> >(&res.result);
