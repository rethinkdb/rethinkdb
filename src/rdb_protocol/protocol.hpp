...
struct rdb_protocol_t {
    ...
    struct read_t {
        ...
        void unshard(read_response_t *responses, size_t count, read_response_t *response, temporary_cache_t *cache) const THROWS_NOTHING;
        void multistore_unshard(read_response_t *responses, size_t count, read_response_t *response, temporary_cache_t *cache) const THROWS_NOTHING;
