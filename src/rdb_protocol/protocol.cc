...
RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(backfill_atom_t, key, value, recency);
...
RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(rdb_protocol::single_sindex_status_t,
                        blocks_total, blocks_processed, ready);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(point_read_response_t, data);
RDB_IMPL_SERIALIZABLE_4_SINCE_1_13(rget_read_response_t,
                        result, key_range, truncated, last_key);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(distribution_read_response_t,
                        region, key_counts);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(sindex_list_response_t, sindexes);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(sindex_status_response_t, statuses);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(changefeed_subscribe_response_t, server_uuids, addrs);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(changefeed_stamp_response_t, stamps);
RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(read_response_t,
                        response, event_log, n_shards);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(point_read_t, key);
RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(sindex_rangespec_t,
...
RDB_IMPL_ME_SERIALIZABLE_4_SINCE_1_13(datum_range_t,
                           empty_ok(left_bound), empty_ok(right_bound),
                           left_bound_type, right_bound_type);
ARCHIVE_PRIM_MAKE_RANGED_SERIALIZABLE(
        sorting_t, int8_t,
        sorting_t::UNORDERED, sorting_t::DESCENDING);
RDB_IMPL_SERIALIZABLE_8_SINCE_1_13(rget_read_t, region, optargs, table_name, batchspec,
                        transforms, terminal, sindex, sorting);

RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(distribution_read_t,
                        max_depth, result_limit, region);
RDB_IMPL_SERIALIZABLE_0_SINCE_1_13(sindex_list_t);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(sindex_status_t, sindexes, region);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(changefeed_subscribe_t, addr, region);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(changefeed_stamp_t, addr, region);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(read_t, read, profile);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(point_write_response_t, result);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(point_delete_response_t, result);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(sindex_create_response_t, success);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(sindex_drop_response_t, success);
RDB_IMPL_SERIALIZABLE_0_SINCE_1_13(sync_response_t);

RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(write_response_t, response, event_log, n_shards);

RDB_IMPL_SERIALIZABLE_5_SINCE_1_13(batched_replace_t,
                        keys, pkey, f, optargs, return_vals);
RDB_IMPL_SERIALIZABLE_4_SINCE_1_13(batched_insert_t,
                        inserts, pkey, upsert, return_vals);

RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(point_write_t, key, data, overwrite);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(point_delete_t, key);
RDB_IMPL_SERIALIZABLE_4_SINCE_1_13(sindex_create_t, id, mapping, region, multi);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(sindex_drop_t, id, region);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(sync_t, region);

RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(write_t,
                        write, durability_requirement, profile);
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(backfill_chunk_t::delete_key_t, key);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(backfill_chunk_t::delete_range_t, range);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(backfill_chunk_t::key_value_pairs_t,
                        backfill_atoms);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(backfill_chunk_t::sindexes_t, sindexes);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(backfill_chunk_t, val);
