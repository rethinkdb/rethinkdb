...
public:
    ...
    {
        guarantee_unreviewed(start >= 0);
        guarantee_unreviewed(stop >= 0);
        guarantee_unreviewed(unbounded || stop >= start);
        stop -= start;
    }
