...
void raw_block::init(int64_t size, direct_file_t *file, off64_t offset) {
    assert(!realbuf);
...
bool raw_block::init(block_size_t size, direct_file_t *file, off64_t offset, ser_block_id_t ser_block_id) {
