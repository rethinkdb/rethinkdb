...
void serve_clustered_memcached(int port, cluster_namespace_interface_t<memcached_protocol_t>& namespace_if) {
    ...
    memcache_listener_t(port, &get_store, &ts_set_store);
}
