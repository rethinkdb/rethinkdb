...
// ctx-less json adapter concept for key_range_t
...
template <class ctx_t>
json_adapter_if_t::json_adapter_map_t get_json_subfields(hash_region_t<key_range_t> *, const ctx_t &);

template <class ctx_t>
cJSON *render_as_json(hash_region_t<key_range_t> *, const ctx_t &);

template <class ctx_t>
void apply_json_to(cJSON *, hash_region_t<key_range_t> *, const ctx_t &);

template <class ctx_t>
void  on_subfield_change(hash_region_t<key_range_t> *, const ctx_t &);

template <class ctx_t>
std::string render_region_as_string(hash_region_t<key_range_t> *target, const ctx_t &ctx);

// ctx-less json adapter concept for hash_region_t<key_range_t>
