...
get_result_t cluster_get_store_t::get(const store_key_t& key, order_token_t token) {
...
rget_result_t cluster_get_store_t::rget(rget_bound_mode_t left_mode, const store_key_t &left_key, rget_bound_mode_t right_mode, const store_key_t &right_key, order_token_t token) {
...
mutation_result_t cluster_set_store_t::change(const mutation_t& m, castime_t cas, order_token_t token) {
