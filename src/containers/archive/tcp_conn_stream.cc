...
tcp_conn_stream_t::tcp_conn_stream_t(SSL_CTX *tls_ctx, const ip_address_t &host, int port, signal_t *interruptor, int local_port)
    : conn_((NULL == tls_ctx) ?
...
keepalive_tcp_conn_stream_t::keepalive_tcp_conn_stream_t(SSL_CTX *tls_ctx, const ip_address_t &host, int port, signal_t *interruptor, int local_port) :
