...
dummy_protocol_t::store_t::store_t(const std::string& fn, bool create, storage_stats_t *) : store_view_t<dummy_protocol_t>(dummy_protocol_t::region_t('a', 'z')), filename(fn) {
    if (create) {
        initialize_empty();
    } else {
