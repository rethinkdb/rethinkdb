...
public:
    ...
    directory_echo_wrapper_t(internal_t i, directory_echo_version_t v, const mailbox_t<void(peer_id_t, directory_echo_version_t)>::address_t &am) :
        internal(i), version(v), ack_mailbox(am) { }

    internal_t internal;
    directory_echo_version_t version;
    mailbox_t<void(peer_id_t, directory_echo_version_t)>::address_t ack_mailbox;
...
private:
    ...
    void ack_version(mailbox_t<void(peer_id_t, directory_echo_version_t)>::address_t peer, directory_echo_version_t version, auto_drainer_t::lock_t);
