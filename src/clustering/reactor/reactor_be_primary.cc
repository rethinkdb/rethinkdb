 ...
 */
template <class protocol_t>
bool reactor_t<protocol_t>::is_safe_for_us_to_be_primary(const std::map<peer_id_t, reactor_business_card_t<protocol_t> > &_reactor_directory, const blueprint_t<protocol_t> &blueprint,
