...
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(backfill_location_t *target, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["backfill_session_id"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<backfill_session_id_t, ctx_t>(&target->backfill_session_id, ctx));
    res["peer_id"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<peer_id_t, ctx_t>(&target->peer_id, ctx));
    res["activity_id"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<reactor_activity_id_t, ctx_t>(&target->activity_id, ctx));
    return res;
}
...
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(primary_when_safe_t<protocol_t> *target, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("primary_when_safe", ctx));
    res["backfillers"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<std::vector<backfill_location_t>, ctx_t>(&target->backfills_waited_on, ctx));
    return res;
}
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(primary_t<protocol_t> *target, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("primary", ctx));
    res["replier_present"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<bool, ctx_t>(target->replier.is_initialized(), ctx));
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(secondary_up_to_date_t<protocol_t> *target, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("secondary_up_to_date", ctx));
    res["branch_id"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<branch_id_t, ctx_t>(&target->branch_id, ctx));
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(secondary_without_primary_t<protocol_t> *, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("secondary_without_primary", ctx));
    // TODO: git blame this and ask why it's commented out.
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(secondary_backfilling_t<protocol_t> *target, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("secondary_backfilling", ctx));
    res["backfiller"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<backfill_location_t, ctx_t>(&target->backfill, ctx));
    return res;
}
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(nothing_when_safe_t<protocol_t> *, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("nothing_when_safe", ctx));
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(nothing_t<protocol_t> *, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("nothing", ctx));
    return res;
}
...
template <class protocol_t, class ctx_t>
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(nothing_when_done_erasing_t<protocol_t>*, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["type"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_temporary_adapter_t<std::string, ctx_t>("nothing_when_done_erasing", ctx));
    return res;
}
...
typename json_adapter_if_t<ctx_t>::json_adapter_map_t get_json_subfields(reactor_business_card_t<protocol_t> *target, const ctx_t &ctx) {
    typename json_adapter_if_t<ctx_t>::json_adapter_map_t res;
    res["activity_map"] = boost::shared_ptr<json_adapter_if_t<ctx_t> >(new json_adapter_t<typename reactor_business_card_t<protocol_t>::activity_map_t, ctx_t>(&target->activities, ctx));
    return res;
}
