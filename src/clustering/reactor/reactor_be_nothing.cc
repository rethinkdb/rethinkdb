...
bool reactor_t<protocol_t>::is_safe_for_us_to_be_nothing(const std::map<peer_id_t, boost::shared_ptr<const reactor_business_card_t<protocol_t> > > &_reactor_directory, const blueprint_t<protocol_t> &blueprint,
