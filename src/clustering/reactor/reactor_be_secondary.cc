...
bool reactor_t<protocol_t>::find_broadcaster_in_directory(const typename protocol_t::region_t &region, const blueprint_t<protocol_t> &bp, const std::map<peer_id_t, reactor_business_card_t<protocol_t> > &_reactor_directory,
    ...
    typedef std::map<peer_id_t, rb_t> reactor_directory_t;
...
template <class protocol_t>
bool reactor_t<protocol_t>::find_replier_in_directory(const typename protocol_t::region_t &region, const branch_id_t &b_id, const blueprint_t<protocol_t> &bp, const std::map<peer_id_t, reactor_business_card_t<protocol_t> > &_reactor_directory,
