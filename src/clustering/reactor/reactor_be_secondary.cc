        ...
        while (true) {
...

            {
                ...
                run_until_satisfied_2(
                    ...
                    blueprint,
                    boost::bind(&reactor_t<protocol_t>::find_broadcaster_in_directory, this, region,
                                _2, _1, &broadcaster),
                    interruptor);
                ...
                run_until_satisfied_2(
                    directory_echo_mirror.get_internal(),
                    blueprint,
                    boost::bind(&reactor_t<protocol_t>::find_replier_in_directory, this, region,
                                branch_id, _2, _1,
            ...
            try {
                ...
                listener_t<protocol_t> listener(base_path, storage_ctx, mailbox_manager, ct_broadcaster.get_watchable(), branch_history_manager, svs, ct_location_to_backfill_from.get_watchable(), backfill_session_id, &regions_perfmon_collection, &ct_interruptor, &order_source);
