...
public:
    ...
    typedef mailbox_t< void(
        ...
        order_token_t,
        typename mailbox_t< void(boost::variant<typename protocol_t::read_response_t, std::string>)>::address_t
        )> read_mailbox_t;
    typedef mailbox_t< void(
        typename protocol_t::write_t,
        order_token_t,
        typename mailbox_t< void(boost::variant<typename protocol_t::write_response_t, std::string>)>::address_t
        )> write_mailbox_t;
