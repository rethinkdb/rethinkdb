...
public:
    ...
    typedef mailbox_t< void(
        typename protocol_t::write_t, transition_timestamp_t, fifo_enforcer_write_token_t,
        addr_t<void(typename protocol_t::write_response_t)>
        )> writeread_mailbox_t;

    typedef mailbox_t< void(
        typename protocol_t::read_t, state_timestamp_t, fifo_enforcer_read_token_t,
        addr_t<void(typename protocol_t::read_response_t)>
        )> read_mailbox_t;
...
struct backfiller_business_card_t {
    ...
    typedef mailbox_t< void(
        ...
        addr_t<void(region_map_t<protocol_t, version_range_t>)>,
        addr_t<void(typename protocol_t::backfill_chunk_t)>,
...
struct replier_business_card_t {
    ...
    typedef mailbox_t<void(state_timestamp_t, addr_t<void()>)> synchronize_mailbox_t;
