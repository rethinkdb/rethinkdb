...
public:
    ...
    typedef mailbox_t< void(
        typename writeread_mailbox_t::address_type,
        typename read_mailbox_t::address_type
        )> upgrade_mailbox_t;
    ...
    typedef mailbox_t< void(
        state_timestamp_t,
        typename upgrade_mailbox_t::address_type,
        typename downgrade_mailbox_t::address_type
        )> intro_mailbox_t;

    listener_business_card_t() { }
    listener_business_card_t(
            const typename intro_mailbox_t::address_type &im,
            const typename write_mailbox_t::address_type &wm) :
        intro_mailbox(im), write_mailbox(wm) { }

    typename intro_mailbox_t::address_type intro_mailbox;
...
struct backfiller_business_card_t {
    ...
    backfiller_business_card_t(
            const typename backfill_mailbox_t::address_type &ba,
            const cancel_backfill_mailbox_t::address_type &cba) :
        backfill_mailbox(ba), cancel_backfill_mailbox(cba)
        { }

    typename backfill_mailbox_t::address_type backfill_mailbox;
    cancel_backfill_mailbox_t::address_type cancel_backfill_mailbox;
...
struct replier_business_card_t {
    ...
    synchronize_mailbox_t::address_type synchronize_mailbox;
    ...
    replier_business_card_t(const synchronize_mailbox_t::address_type &_synchronize_mailbox, const backfiller_business_card_t<protocol_t> &_backfiller_bcard)
