...
RDB_MAKE_SERIALIZABLE_2(version_t, branch, timestamp);
...
RDB_MAKE_SERIALIZABLE_2(version_range_t, earliest, latest);
...
RDB_MAKE_SERIALIZABLE_3(branch_birth_certificate_t,
...
RDB_MAKE_SERIALIZABLE_1(branch_history_t, branches);
