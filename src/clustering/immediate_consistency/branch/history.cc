...
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(version_t, branch, timestamp);
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(version_range_t, earliest, latest);
...
RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(branch_birth_certificate_t,
                        region, initial_timestamp, origin);
RDB_IMPL_EQUALITY_COMPARABLE_3(branch_birth_certificate_t,
                               region, initial_timestamp, origin);

RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(branch_history_t, branches);
