...
`contract_t`s in the `table_raft_state_t`. It constantly monitors the current Raft state
...
private:
    ...
    public:
        ...
        scoped_ptr_t<primary_execution_t> primary;
        scoped_ptr_t<secondary_execution_t> secondary;
        scoped_ptr_t<erase_execution_t> erase;
    };
    ...
    watchable_map_t<std::pair<server_id_t, branch_id_t>, contract_execution_bcard_t>
        *const remote_contract_execution_bcards;
