...
public:
    log_http_app_t(
            ...
            const clone_ptr_t<watchable_t<std::map<peer_id_t, server_id_t> > > &server_id_translation_table);
...
private:
    ...
    clone_ptr_t<watchable_t<std::map<peer_id_t, server_id_t> > > server_id_translation_table;
