...
public:
    distribution_app_t(boost::shared_ptr<semilattice_read_view_t<namespaces_semilattice_metadata_t<memcached_protocol_t> > >, namespace_repo_t<memcached_protocol_t> *,
                       boost::shared_ptr<semilattice_read_view_t<namespaces_semilattice_metadata_t<rdb_protocol_t> > >, namespace_repo_t<rdb_protocol_t> *);
...
private:
    ...
    boost::shared_ptr<semilattice_read_view_t<namespaces_semilattice_metadata_t<rdb_protocol_t> > > rdb_namespaces_sl_metadata;
