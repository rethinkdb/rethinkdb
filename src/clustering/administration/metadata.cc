...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(database_semilattice_metadata_t, name);
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(databases_semilattice_metadata_t, databases);
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(datacenter_semilattice_metadata_t, name);
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(datacenters_semilattice_metadata_t, datacenters);
...
RDB_IMPL_SERIALIZABLE_2_SINCE_1_13(machine_semilattice_metadata_t, datacenter, name);
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(machines_semilattice_metadata_t, machines);
...
RDB_IMPL_ME_SERIALIZABLE_2_SINCE_1_13(ack_expectation_t, expectation_, hard_durability_);

RDB_IMPL_SERIALIZABLE_10_SINCE_1_13(namespace_semilattice_metadata_t,
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(namespaces_semilattice_metadata_t, namespaces);
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(namespaces_directory_metadata_t, reactor_bcards);
RDB_IMPL_EQUALITY_COMPARABLE_1(namespaces_directory_metadata_t, reactor_bcards);

RDB_IMPL_SERIALIZABLE_4_SINCE_1_13(cluster_semilattice_metadata_t,
...
RDB_IMPL_SERIALIZABLE_1_SINCE_1_13(auth_semilattice_metadata_t, auth_key);
...
RDB_IMPL_SERIALIZABLE_11_SINCE_1_13(cluster_directory_metadata_t,
