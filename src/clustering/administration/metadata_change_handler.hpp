...
public:
    ...
    public:
            ...
            interest_acquired(true)
        {
            ...
            disconnect_watcher_t dc_watcher(mailbox_manager, _request_mailbox.get_peer());
        ...
        bool update(const metadata_t &metadata) {
            ...
            disconnect_watcher_t dc_watcher(mailbox_manager, commit_mailbox_address.get_peer());
