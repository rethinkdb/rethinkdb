...
public:
    semilattice_watching_persister_t(const std::string& file_path, machine_id_t machine_id, boost::shared_ptr<semilattice_read_view_t<cluster_semilattice_metadata_t> > view);
private:
    void dump();
