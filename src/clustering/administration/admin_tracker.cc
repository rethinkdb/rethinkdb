...
admin_tracker_t::admin_tracker_t(
    ...
    remote_issue_tracker(
        directory_view->incremental_subview(
            incremental_field_getter_t<std::list<local_issue_t>,
    ...
    outdated_index_client(
        mailbox_manager,
        directory_view->incremental_subview(
            incremental_field_getter_t<outdated_index_issue_server_t::request_address_t,
                                       cluster_directory_metadata_t>(
                &cluster_directory_metadata_t::get_outdated_indexes_mailbox))),
    outdated_index_issue_tracker_feed(&issue_aggregator, &outdated_index_client),
