...
#ifndef CLUSTERING_ADMINISTRATION_AUTH_PASSWORD_HPP_
#define CLUSTERING_ADMINISTRATION_AUTH_PASSWORD_HPP_
...
#endif  // CLUSTERING_ADMINISTRATION_AUTH_PASSWORD_HPP_
