...
#ifndef CLUSTERING_ADMINISTRATION_AUTH_BASE_AUTHENTICATOR_HPP_
#define CLUSTERING_ADMINISTRATION_AUTH_BASE_AUTHENTICATOR_HPP_
...
#endif  // CLUSTERING_ADMINISTRATION_AUTH_BASE_AUTHENTICATOR_HPP_
