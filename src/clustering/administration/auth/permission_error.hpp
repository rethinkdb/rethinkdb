...
#ifndef CLUSTERING_ADMINISTRATION_AUTH_PERMISSION_ERROR_HPP_
#define CLUSTERING_ADMINISTRATION_AUTH_PERMISSION_ERROR_HPP_
...
#endif  // CLUSTERING_ADMINISTRATION_AUTH_PERMISSION_ERROR_HPP_
