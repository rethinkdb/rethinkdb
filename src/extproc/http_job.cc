...
void http_job_t::http(const http_opts_t &opts,
                      http_result_t *res_out) {
    write_message_t msg;
    serialize<cluster_version_t::LATEST_VERSION>(&msg, opts);
    {
...
bool http_job_t::worker_fn(read_stream_t *stream_in, write_stream_t *stream_out) {
    ...
    {
        archive_result_t res
            = deserialize<cluster_version_t::LATEST_VERSION>(stream_in, &opts);
    ...
    write_message_t msg;
    serialize<cluster_version_t::LATEST_VERSION>(&msg, result);
