...
RDB_IMPL_ME_SERIALIZABLE_3_SINCE_1_13(http_result_t, empty_ok(header), empty_ok(body), error);
RDB_IMPL_SERIALIZABLE_3_SINCE_1_13(http_opts_t::http_auth_t, type, username, password);
RDB_IMPL_ME_SERIALIZABLE_13_SINCE_1_13(http_opts_t, auth, method, result_format, url,
