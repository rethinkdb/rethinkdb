...
RDB_IMPL_SERIALIZABLE_3_FOR_CLUSTER(http_result_t, header, body, error);
RDB_IMPL_SERIALIZABLE_3_SINCE_v1_13(http_opts_t::http_auth_t, type, username, password);
RDB_IMPL_SERIALIZABLE_14(http_opts_t,
    auth, method, result_format, url, proxy, url_params, header, data, form_data, limits,
