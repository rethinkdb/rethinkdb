...
RDB_IMPL_SERIALIZABLE_15(http_opts_t,
    auth, method, result_format, url, proxy, url_params, header, cookies, data,
    form_data, limits, timeout_ms, attempts, max_redirects, verify);
