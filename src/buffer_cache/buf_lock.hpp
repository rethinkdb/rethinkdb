...
public:
    ...
    // TODO: get rid of thread_saver_t
    buf_lock_t(const thread_saver_t& saver, transaction_t *tx, block_id_t block_id, access_t mode);
    buf_lock_t(const thread_saver_t& saver, transactor_t& txor, block_id_t block_id, access_t mode);
    ~buf_lock_t();
