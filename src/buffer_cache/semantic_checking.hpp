...
{
public:
    scc_transaction_t(scc_cache_t<inner_cache_t> *cache, access_t access, int expected_change_count, repli_timestamp_t recency_timestamp, order_token_t _order_token, cond_t *disk_ack_signal);
    ~scc_transaction_t();
