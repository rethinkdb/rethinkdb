...
bool mock_cache_t::offer_read_ahead_buf(UNUSED block_id_t block_id, UNUSED void *buf, UNUSED const refc_ptr<standard_block_token_t>& token, UNUSED repli_timestamp_t recency_timestamp) {
