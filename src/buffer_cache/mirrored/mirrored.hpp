...
class mc_inner_buf_t : public evictable_t,
    ...
    mc_inner_buf_t(cache_t *cache, block_id_t block_id, void *buf, const refc_ptr_t<standard_block_token_t>& token, repli_timestamp_t recency_timestamp);
    ...
    void update_data_token(const void *data, const refc_ptr_t<standard_block_token_t>& token);
...
private:
    ...
    refc_ptr_t<standard_block_token_t> data_token;
...
private:
    void offer_read_ahead_buf_home_thread(block_id_t block_id, void *buf, const refc_ptr_t<standard_block_token_t>& token, repli_timestamp_t recency_timestamp);
