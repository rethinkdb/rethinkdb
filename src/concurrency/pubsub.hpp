...
private:
    ...
    explicit publisher_t(int specified_home_thread)
        : home_thread_mixin_t(specified_home_thread), mutex(specified_home_thread) { }
    publisher_t() { }
    ~publisher_t() {
...
{
public:
    explicit publisher_controller_t(int specified_home_thread)
        : home_thread_mixin_t(specified_home_thread), publisher(specified_home_thread) { }
