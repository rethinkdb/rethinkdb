...
# 
#     repeated Term2 args = 3; // Holds the positional arguments of the query.
#     message AssocPair {
#         required string key = 1;
#         required Term2 val = 2;
#     };
