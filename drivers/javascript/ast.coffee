...
class RDBVal extends TermBase
    ...
    bitShl: (args...) -> new BitSal {}, @, args...
    bitShr: (args...) -> new BitShr {}, @, args...
...
class BitShr extends RDBOp
    tt: protoTermType.BIT_SHR
    mt: 'bitShr'
...
rethinkdb.bitShl = (args...) -> new BitSal {}, args...
rethinkdb.bitShr = (args...) -> new BitShr {}, args...
