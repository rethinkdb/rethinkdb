...
public class MetaTable {
    ...
    public void test() throws Exception {
...

        {
            ...
            Map expected_ = r.hashMap("type", "DB").with("name", "rethinkdb").with("id", uuid());
            /* r.db('rethinkdb').info() */
...
'indexes':[],'primary_key':'id'}) */
            Partial expected_ = partial(r.hashMap("db", r.hashMap("type", "DB").with("name", "rethinkdb").with("id", uuid())).with("type", "TABLE").with("id", uuid()).with("name", "stats").with("indexes", r.array()).with("primary_key", "id"));
...

        {
            ...
            /* {"ready":1} */
            Map expected_ = r.hashMap("ready", 1L);
            /* db.table('a').wait(wait_for="all_replicas_ready") */
            logger.info("About to run line #222: db.table('a').wait_().optArg('wait_for', 'all_replicas_ready')");
            Object obtained = runOrCatch(db.table("a").wait_().optArg("wait_for", "all_replicas_ready"),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
...

        {
            ...
            logger.info("About to run line #228: db.table('a').insert(r.array(r.hashMap('id', 1L), r.hashMap('id', 2L), r.hashMap('id', 3L), r.hashMap('id', 4L)))");
...

        {
            ...
            Partial expected_ = partial(r.hashMap("reconfigured", 1L));
            /* db.table('a').reconfigure(shards=2, replicas=1) */
            logger.info("About to run line #233: db.table('a').reconfigure().optArg('shards', 2L).optArg('replicas', 1L)");
            Object obtained = runOrCatch(db.table("a").reconfigure().optArg("shards", 2L).optArg("replicas", 1L),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            logger.info("About to run line #238: db.table('a').reconfigure().optArg('shards', 1L).optArg('replicas', 2L)");
...

        {
            ...
            Map expected_ = r.hashMap("ready", 1L);
            /* db.table('a').wait(wait_for="all_replicas_ready") */
            logger.info("About to run line #244: db.table('a').wait_().optArg('wait_for', 'all_replicas_ready')");
            Object obtained = runOrCatch(db.table("a").wait_().optArg("wait_for", "all_replicas_ready"),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            logger.info("About to run line #248: db.table('a').rebalance()");
...

        {
            ...
            logger.info("About to run line #251: db.wait_().optArg('wait_for', 'all_replicas_ready')");
            Object obtained = runOrCatch(db.wait_().optArg("wait_for", "all_replicas_ready"),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
...

        {
            ...
            Partial expected_ = partial(r.hashMap("rebalanced", 1L));
            /* db.rebalance() */
            logger.info("About to run line #255: db.rebalance()");
...

        {
            ...
            Partial expected_ = partial(r.hashMap("tables_dropped", 1L));
            /* db.table_drop('a') */
            logger.info("About to run line #271: db.tableDrop('a')");
            Object obtained = runOrCatch(db.tableDrop("a"),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            /* db.table_create('a') */
            logger.info("About to run line #275: db.tableCreate('a')");
            Object obtained = runOrCatch(db.tableCreate("a"),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            Object expected_ = AnythingIsFine;
            /* db.table_create('b') */
            logger.info("About to run line #276: db.tableCreate('b')");
            Object obtained = runOrCatch(db.tableCreate("b"),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
            logger.info("Finished running line #276");
            } catch (Throwable ae) {
                logger.error("Whoops, got exception on line #276:" + ae.toString());
                if(obtained instanceof Throwable) {
                    ae.addSuppressed((Throwable) obtained);
                }
                throw ae;
...

        {
            ...
            Object expected_ = AnythingIsFine;
            /* db.table_create('c') */
            logger.info("About to run line #277: db.tableCreate('c')");
...

        {
            ...
            logger.info("About to run line #279: db.reconfigure().optArg('shards', 0L).optArg('replicas', 1L)");
...

        {
            ...
            logger.info("About to run line #284: db.reconfigure().optArg('shards', 1L).optArg('replicas', r.hashMap('default', 0L))");
...

        {
            ...
            logger.info("About to run line #289: db.reconfigure().optArg('shards', 1L).optArg('replicas', r.hashMap('default', -3L)).optArg('primary_replica_tag', 'default')");
...

        {
            ...
            logger.info("About to run line #294: db.reconfigure().optArg('shards', 1L).optArg('replicas', 3L).optArg('primary_replica_tag', 'foo')");
...

        {
            ...
            logger.info("About to run line #299: db.reconfigure().optArg('shards', 2L).optArg('replicas', 1L)");
...

        {
            ...
            Partial expected_ = partial(r.hashMap("tables_dropped", 1L));
            /* db.table_drop('a') */
            logger.info("About to run line #304: db.tableDrop('a')");
            Object obtained = runOrCatch(db.tableDrop("a"),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            Partial expected_ = partial(r.hashMap("tables_dropped", 1L));
            /* db.table_drop('b') */
            logger.info("About to run line #306: db.tableDrop('b')");
            Object obtained = runOrCatch(db.tableDrop("b"),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            Partial expected_ = partial(r.hashMap("tables_dropped", 1L));
            /* db.table_drop('c') */
            logger.info("About to run line #308: db.tableDrop('c')");
...

        {
            ...
            /* r.db_create("test2") */
            logger.info("About to run line #312: r.dbCreate('test2')");
...

        {
            ...
            logger.info("About to run line #317: db.tableCreate('testA')");
...

        {
            ...
            logger.info("About to run line #319: db.tableCreate('testB')");
            Object obtained = runOrCatch(db.tableCreate("testB"),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
            logger.info("Finished running line #319");
            } catch (Throwable ae) {
                logger.error("Whoops, got exception on line #319:" + ae.toString());
                if(obtained instanceof Throwable) {
                    ae.addSuppressed((Throwable) obtained);
                }
                throw ae;
...

        {
            ...
            logger.info("About to run line #321: db2.tableCreate('test2B')");
...

        {
            ...
            logger.info("About to run line #324: r.table('testA').config().pluck('db', 'name')");
...

        {
            ...
            logger.info("About to run line #327: r.table('doesntexist').config()");
...

        {
            ...
            logger.info("About to run line #330: r.table('test2B').config()");
...

        {
            ...
            logger.info("About to run line #333: r.db('rethinkdb').table('table_config').filter(r.hashMap('name', 'testA')).nth(0L).eq(r.table('testA').config())");
            Object obtained = runOrCatch(r.db("rethinkdb").table("table_config").filter(r.hashMap("name", "testA")).nth(0L).eq(r.table("testA").config()),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
            logger.info("Finished running line #333");
            } catch (Throwable ae) {
                logger.error("Whoops, got exception on line #333:" + ae.toString());
                if(obtained instanceof Throwable) {
                    ae.addSuppressed((Throwable) obtained);
                }
                throw ae;
...

        {
            ...
            logger.info("About to run line #336: r.db('rethinkdb').table('table_status').filter(r.hashMap('name', 'testA')).nth(0L).eq(r.table('testA').status())");
            Object obtained = runOrCatch(r.db("rethinkdb").table("table_status").filter(r.hashMap("name", "testA")).nth(0L).eq(r.table("testA").status()),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
            logger.info("Finished running line #336");
            } catch (Throwable ae) {
                logger.error("Whoops, got exception on line #336:" + ae.toString());
                if(obtained instanceof Throwable) {
                    ae.addSuppressed((Throwable) obtained);
                }
                throw ae;
...

        {
            ...
            logger.info("About to run line #339: r.db('rethinkdb').table('table_config').optArg('identifier_format', 'uuid').nth(0L).bracket('db')");
...

        {
            ...
            logger.info("About to run line #344: r.table('testA').optArg('identifier_format', 'uuid').count()");
            Object obtained = runOrCatch(r.table("testA").optArg("identifier_format", "uuid").count(),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
            logger.info("Finished running line #344");
            } catch (Throwable ae) {
                logger.error("Whoops, got exception on line #344:" + ae.toString());
                if(obtained instanceof Throwable) {
                    ae.addSuppressed((Throwable) obtained);
                }
                throw ae;
...

        {
            ...
            Partial expected_ = partial(r.hashMap("tables_dropped", 1L));
            /* db.table_drop('testA') */
            logger.info("About to run line #358: db.tableDrop('testA')");
...

        {
            ...
            Partial expected_ = partial(r.hashMap("tables_dropped", 1L));
            /* db.table_drop('testB') */
            logger.info("About to run line #361: db.tableDrop('testB')");
...

        {
            ...
            /* r.db_drop('test2') */
            logger.info("About to run line #364: r.dbDrop('test2')");
            Object obtained = runOrCatch(r.dbDrop("test2"),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
            logger.info("Finished running line #364");
            } catch (Throwable ae) {
                logger.error("Whoops, got exception on line #364:" + ae.toString());
                if(obtained instanceof Throwable) {
                    ae.addSuppressed((Throwable) obtained);
                }
                throw ae;
