...
public class MutationInsert {
    ...
    public void test() throws Exception {
...

        {
            ...
            Map expected_ = r.hashMap("changes", r.array(r.hashMap("new_val", r.hashMap("id", 666L)).with("old_val", null), r.hashMap("error", "Duplicate primary key `id`:\n{\n\t\"id\":\t666\n}\n{\n\t\"id\":\t666\n}").with("new_val", r.hashMap("id", 666L)).with("old_val", r.hashMap("id", 666L)))).with("deleted", 0L).with("errors", 1L).with("first_error", "Duplicate primary key `id`:\n{\n\t\"id\":\t666\n}\n{\n\t\"id\":\t666\n}").with("inserted", 1L).with("replaced", 0L).with("skipped", 0L).with("unchanged", 0L);
            /* tbl.insert([{'id':666}, {'id':666}], return_changes="always") */
            logger.info("About to run line #159: tbl.insert(r.array(r.hashMap('id', 666L), r.hashMap('id', 666L))).optArg('return_changes', 'always')");
            Object obtained = runOrCatch(tbl.insert(r.array(r.hashMap("id", 666L), r.hashMap("id", 666L))).optArg("return_changes", "always"),
                                          new OptArgs()
                                          ,conn);
            try {
                assertEquals(expected_, obtained);
...

        {
            ...
            logger.info("About to run line #163: tbl.insert(LongStream.range(1L, 100L).boxed().map(i -> r.hashMap('id', r.add(100L, i)).with('ordered-num', i)).collect(Collectors.toList())).optArg('return_changes', 'always')");
...

        {
            ...
            logger.info("About to run line #167: tbl.insert(LongStream.range(1L, 100L).boxed().map(i -> r.hashMap('id', r.array(1L, 'blah', r.add(200L, i))).with('ordered-num', i)).collect(Collectors.toList())).optArg('return_changes', 'always')");
...

        {
            ...
            logger.info("About to run line #171: tbl.insert(LongStream.range(1L, 100L).boxed().map(i -> r.hashMap('id', r.array(1L, 'blah', r.add(300L, i))).with('ordered-num', i)).collect(Collectors.toList())).optArg('return_changes', true)");
...

        {
            ...
            Partial expected_ = partial(r.hashMap("changes", LongStream.range(1L, 100L).boxed().map(i -> r.hashMap("old_val", r.hashMap("id", 100L + i).with("ordered-num", i)).with("new_val", r.hashMap("id", 100L + i).with("ordered-num", i)).with("error", "Duplicate primary key `id`:\n{\n\t\"id\":\t" + str(100L + i) + ",\n\t\"ordered-num\":\t" + str(i) + "\n}\n{\n\t\"id\":\t" + str(100L + i) + ",\n\t\"ordered-num\":\t" + str(i) + "\n}")).collect(Collectors.toList())));
            /* tbl.insert([{'id':100 + i, 'ordered-num':i} for i in range(1,100)], return_changes="always") */
            logger.info("About to run line #175: tbl.insert(LongStream.range(1L, 100L).boxed().map(i -> r.hashMap('id', r.add(100L, i)).with('ordered-num', i)).collect(Collectors.toList())).optArg('return_changes', 'always')");
            Object obtained = runOrCatch(tbl.insert(LongStream.range(1L, 100L).boxed().map(i -> r.hashMap("id", r.add(100L, i)).with("ordered-num", i)).collect(Collectors.toList())).optArg("return_changes", "always"),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            logger.info("About to run line #183: tbl.insert(LongStream.range(1L, 100L).boxed().map(i -> r.hashMap('id', r.add(100L, i)).with('ordered-num', i)).collect(Collectors.toList())).optArg('return_changes', true)");
...

        {
            ...
            logger.info("About to run line #186: tbl.insert(r.hashMap('a', r.minval())).optArg('return_changes', 'always')");
...

        {
            ...
            logger.info("About to run line #192: tbl.insert(r.hashMap('id', 42L).with('foo', 1L).with('bar', 1L))");
...

        {
            ...
            logger.info("About to run line #194: tbl.insert(r.hashMap('id', 42L).with('foo', 5L).with('bar', 5L)).optArg('conflict', (id, old_row, new_row) -> old_row.merge(new_row.pluck('bar')))");
...

        {
            ...
            /* tbl.get(42) */
            logger.info("About to run line #196: tbl.get(42L)");
...

        {
            ...
            logger.info("About to run line #214: tbl.insert(r.hashMap('id', 42L).with('foo', 1L).with('bar', 1L)).optArg('conflict', (a, b, c) -> 2L)");
...

        {
            ...
            logger.info("About to run line #218: tbl.insert(r.hashMap('id', 42L)).optArg('conflict', (a, b) -> a)");
...

        {
            ...
            logger.info("About to run line #222: tbl.insert(r.hashMap('id', 42L)).optArg('conflict', (a, b, c) -> tbl.get(42L))");
...

        {
            ...
            logger.info("About to run line #225: tbl.insert(r.hashMap('id', 42L)).optArg('conflict', (a, b, c) -> r.hashMap('id', 42L).with('num', '424'))");
...

        {
            ...
            /* tbl.get(42) */
            logger.info("About to run line #227: tbl.get(42L)");
            Object obtained = runOrCatch(tbl.get(42L),
                                          new OptArgs()
                                          ,conn);
            try {
...

        {
            ...
            /* r.minval */
            logger.info("About to run line #231: r.minval()");
...

        {
            ...
            /* r.maxval */
            logger.info("About to run line #234: r.maxval()");
...

        {
            ...
            logger.info("About to run line #238: r.db('test').tableDrop('test2')");
