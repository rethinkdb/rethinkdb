[(r("test").db_create),
 ...
 (r.db("test").table("tbl").between({:right_bound => 2, :left_bound => 1})),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
   [{:id => 0, :name => "0", :num => 0},
    {:id => 1, :name => "1", :num => 1},
 ...
 (r.funcall(lambda {|var_11| var_11}, 3)),
 (r.funcall(lambda {|var_12, var_13| var_12}, 3)),
 (r.funcall(lambda {|var_14, var_15| var_14}, 3, 4)),
 (r.funcall(lambda {|var_16, var_17| var_17}, 3, 4)),
 (r.funcall(lambda {|var_18, var_19| var_18.add(var_19)}, 3, 4)),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r("8226648793918755503").db_create),
 (r.db("8226648793918755503").table_create("8366279191818520939")),
 (r.db("8226648793918755503").table("8366279191818520939").insert(
   [{:id => 0, :name => "0", :num => 0},
    {:id => 1, :name => "1", :num => 1},
    {:id => 2, :name => "2", :num => 2},
    {:id => 3, :name => "3", :num => 3},
 ...
 (r.db("8226648793918755503").table("8366279191818520939").orderby(
   "id"
 ).foreach {|var_20|
   [r.db("8226648793918755503").table("8366279191818520939").update {|var_21|
      var_20["id"].eq(var_21["id"]).branch({:num => var_21["num"].mul(2)}, nil)
    },
    r.db("8226648793918755503").table("8366279191818520939").filter {|var_22|
      var_22["id"].eq(var_20["id"])
    }.replace {|var_23| var_23["id"].mod(2).eq(1).branch(nil, var_23)},
    r.db("8226648793918755503").table("8366279191818520939").get(0).delete,
    r.db("8226648793918755503").table("8366279191818520939").get(12).delete]
 }),
 (r.db("8226648793918755503").table("8366279191818520939").orderby("id")),
 (r("8226648793918755503").db_drop),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r("foreach_multi7112731608527472748").db_create),
 (r.db("foreach_multi7112731608527472748").table_create(
   "foreach_multi_tbl16010663780283109958"
 )),
 (r.db("foreach_multi7112731608527472748").table_create(
   "foreach_multi_tbl1601066378028310995811749459793513277220"
 )),
 (r.db("foreach_multi7112731608527472748").table_create(
   "foreach_multi_tbl160106637802831099581174945979351327722014734224175977098144"
 )),
 (r.db("foreach_multi7112731608527472748").table_create(
   "foreach_multi_tbl1601066378028310995811749459793513277220147342241759770981447628147332711596311"
 )),
 (r.db("foreach_multi7112731608527472748").table(
   "foreach_multi_tbl16010663780283109958"
 ).insert(
   [{:id => 0, :name => "0", :num => 0},
    {:id => 1, :name => "1", :num => 1},
 ...
 (r("foreach_multi7112731608527472748").db_drop),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r.db("test").table("tbl").groupby(["gb"], {:COUNT => true})),
 ...
 (r([{:id => 0, :name => "0", :num => 0},
  ...
  {:id => 7, :name => "7", :num => 7},
  {:id => 8, :name => "8", :num => 8},
  {:id => 9, :name => "9", :num => 9}]).grouped_map_reduce(
 ...
 (r("8622750707037327833").db_create),
 (r.db("8622750707037327833").table_create("55466297270685551091")),
 (r.db("8622750707037327833").table_create("55466297270685551092")),
 (r.db("8622750707037327833").table("55466297270685551091").insert(
   [{:a => 0, :id => 0},
    {:a => 2, :id => 1},
    {:a => 4, :id => 2},
    {:a => 6, :id => 3},
 ...
 (r.db("8622750707037327833").table("55466297270685551092").insert(
   [{:b => 0, :id => 0},
    {:b => 100, :id => 1},
    {:b => 200, :id => 2},
    {:b => 300, :id => 3},
 ...
 (r.db("8622750707037327833").table("55466297270685551091").eq_join(
   "a",
   r.db("8622750707037327833").table("55466297270685551092")
 )),
 (r.db("8622750707037327833").table("55466297270685551091").inner_join(
   r.db("8622750707037327833").table("55466297270685551092")
 ...
 (r.db("8622750707037327833").table("55466297270685551091").filter {|var_68|
   r.db("8622750707037327833").table("55466297270685551092").get(
     var_68["a"]
   ).eq(nil)
 }.map {|var_69| {:left => var_69}}),
 (r.db("8622750707037327833").table("55466297270685551091").outer_join(
   r.db("8622750707037327833").table("55466297270685551092")
 ) {|var_70, var_71| var_70["a"].eq(var_71["id"])}),
 (r.db("8622750707037327833").table("55466297270685551091").outer_join(
   r.db("8622750707037327833").table("55466297270685551092")
 ) {|var_72, var_73| var_72["a"].eq(var_73["id"])}.zip),
 (r("8622750707037327833").db_drop),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r.db("test").table("tbl").get("cabef37d-1425-494d-a47f-08a27f8ab4ef").delete),
 ...
 (r.db("test").table("tbl").get(0).replace { nil}),
 (r.db("test").table("tbl").orderby("id")),
 (r.db("test").table("tbl").get(0).replace { {:id => 0, :name => "0", :num => 0}}),
 ...
 (r.db("test").table("tbl", {:use_outdated => true}).filter {|var_85|
   var_85["id"].lt(5)
 }.between({:right_bound => 3, :left_bound => 2}).replace { nil}),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r.db("test").table("tbl").get(0).delete),
 (r.db("test").table("tbl").orderby("id")),
 (r.db("test").table("tbl").insert({:id => 0, :name => "0", :num => 0})),
 (r.db("test").table("tbl").orderby("id")),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 ...
 (r.db("test").table("tbl").between({:right_bound => 3, :left_bound => 1})),
 (r.db("test").table("tbl").between({:right_bound => 3, :left_bound => 3})),
 (r.db("test").table("tbl").between({:left_bound => 2})),
 (r.db("test").table("tbl").between({:right_bound => 3, :left_bound => 1})),
 (r.db("test").table("tbl").between({:right_bound => 4})),
 (r([1]).between({:right_bound => 3, :left_bound => 1})),
 (r([1, 2]).between({:right_bound => 3, :left_bound => 1})),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r.funcall(lambda {|var_98| [var_98, var_98]}, 1)),
 (r("test").db_create),
 (r.db("test").table_create("tbl")),
 (r.db("test").table("tbl").delete),
 (r.db("test").table("tbl").insert(
 ...
 (r.db_list),
 (r("16739011912059106749").db_create),
 (r("16739011912059106749").db_create),
 (r.db_list),
 (r.db("16739011912059106749").table_create("15682103862325378068")),
 (r.db("16739011912059106749").table_create("15682103862325378068")),
 (r.db("16739011912059106749").table_list),
 (r.db("16739011912059106749").table("15682103862325378068").insert({:id => 0})),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table_create(
   "1568210386232537806815682103862325378068"
 )),
 (r.db("16739011912059106749").table_list),
 (r.db("").table("")),
 (r.db("test").table("15682103862325378068")),
 (r.db("16739011912059106749").table("")),
 (r.db("16739011912059106749").table_drop(
   "1568210386232537806815682103862325378068"
 )),
 (r.db("16739011912059106749").table("1568210386232537806815682103862325378068")),
 (r("16739011912059106749").db_drop),
 (r.db_list),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r("16739011912059106749").db_create),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table_create("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").insert(
   [{:id => 0, :name => "0", :num => 0},
    {:id => 1, :name => "1", :num => 1},
    {:id => 2, :name => "2", :num => 2},
    {:id => 3, :name => "3", :num => 3},
 ...
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").filter {|var_101|
   var_101["id"].eq(0)
 }.replace { {:id => 0, :name => "0", :num => 0}}),
 (r.db("16739011912059106749").table("15682103862325378068").update {|var_102|
   var_102.contains("broken").branch(
     {:id => 1, :name => "1", :num => 1},
     var_102
   )
 }),
 (r.db("16739011912059106749").table("15682103862325378068").replace {|var_103|
   {:num => var_103["num"], :name => var_103["name"], :id => var_103["id"]}
 }),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").replace {|var_104|
   var_104["id"].eq(4).any(var_104["id"].eq(5)).branch({:id => -1}, var_104)
 }),
 (r.db("16739011912059106749").table("15682103862325378068").get(5).update {
   {:num => "5"}
 }),
 (r.db("16739011912059106749").table("15682103862325378068").replace {|var_105|
   var_105.merge({:num => var_105["num"].mul(2)})
 }),
 (r.db("16739011912059106749").table("15682103862325378068").get(5)),
 (r.db("16739011912059106749").table("15682103862325378068").replace {|var_106|
 ...
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").get(0).update {
   {:num => 2}
 }),
 (r.db("16739011912059106749").table("15682103862325378068").get(0)),
 (r.db("16739011912059106749").table("15682103862325378068").get(0).update { nil}),
 (r.db("16739011912059106749").table("15682103862325378068").get(0).replace {
   {:id => 0, :name => "0", :num => 0}
 }),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").filter {|var_107|
   var_107["id"].lt(5)
 }.delete),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").delete),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").insert(
   [{:id => 0, :name => "0", :num => 0},
    {:id => 1, :name => "1", :num => 1},
 ...
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").replace {|var_108|
   var_108
 }),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").replace {|var_109|
 ...
 (r.db("16739011912059106749").table("15682103862325378068").foreach {|var_110|
   [r.db("16739011912059106749").table("15682103862325378068").get(
      var_110["id"]
    ).delete,
    r.db("16739011912059106749").table("15682103862325378068").insert(
      var_110,
 ...
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").foreach {|var_111|
   r.db("16739011912059106749").table("15682103862325378068").get(
     var_111["id"]
   ).delete
 }),
 ...
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r.db("16739011912059106749").table("15682103862325378068").get(1).replace {
   {:id => -1}
 }),
 (r.db("16739011912059106749").table("15682103862325378068").get(
   1
 ...
 (r.db("16739011912059106749").table("15682103862325378068").get(1)),
 (r.db("16739011912059106749").table("15682103862325378068").insert(
   [{:id => 0, :name => "0", :num => 0}, {:id => 1, :name => "1", :num => 1}],
   {:upsert => true}
 )),
 (r.db("16739011912059106749").table("15682103862325378068")),
 (r("16739011912059106749").db_drop),
 ...
 (r.db("test").table("tbl").update {|var_139|
   {:x => r.funcall(lambda { 1}, r.db("test").table("tbl").get(0))}
 }),
 ...
 (r.db("test").table("tbl").get(0).update({:non_atomic => true}) {|var_145|
   {:x => r.funcall(lambda { 2}, r.db("test").table("tbl").get(0))}
 }),
 ...
 (r.db("test").table("tbl").update {|var_152|
   r.funcall(lambda { true}, r.db("test").table("tbl").get(0)).branch(
     nil,
     {:x => 0.1}
   )
 }),
 ...
 (r.db("test").table("tbl").replace {|var_165|
   r.funcall(lambda { var_165}, r.db("test").table("tbl").get(0))
 }),
 (r.db("test").table("tbl").replace({:non_atomic => true}) {|var_166|
   r.funcall(lambda { var_166}, r.db("test").table("tbl").get(0))["id"].eq(
     1
 ...
 (r.db("test").table("tbl").get(0).replace {|var_170|
   r.funcall(lambda { r("").error}, r.db("test").table("tbl").get(0)).branch(
     var_170,
     nil
   )
 }),
 ...
 (r.db("test").table("tbl").replace {|var_185|
   r.funcall(lambda { var_185}, r.db("test").table("tbl").get(0))["id"].lt(
     3
   ).branch(nil, var_185)
 }),
 (r.db("test").table("tbl").replace({:non_atomic => true}) {|var_186|
   r.funcall(lambda { var_186}, r.db("test").table("tbl").get(0))["id"].lt(
     3
   ).branch(nil, var_186)
 }),
